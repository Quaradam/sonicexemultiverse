function onCreate()
	makeLuaSprite('black', 'blam/black', -350, -300)
	scaleObject('black', 100, 1000);
	setScrollFactor('black', 0,0)
	setProperty('black.alpha', 0)
	addLuaSprite('black', false)
	makeLuaSprite('blue', 'blam/blue', -350, -300)
	...
	makeLuaSprite('orange', 'blam/orange', -350, -300)
	...
	makeLuaSprite('green', 'blam/green', -350, -300)
	...
	makeLuaSprite('pink', 'blam/pink', -350, -300)
	...
	makeLuaSprite('red', 'blam/red', -350, -300)
